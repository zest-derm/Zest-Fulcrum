...
11. drugName - Primary drug being studied. MUST use exact brand name from this list: Humira, Enbrel, Remicade, Cimzia, Simponi, Stelara, Amjevita, Cyltezo, Hadlima, Hyrimoz, Yusimry, Abrilada, Idacio, Erelzi, Eticovo, Avsola, Inflectra, Ixifi, Renflexis, Zymfentra, Skyrizi, Tremfya, Omvoh, Ilumya, Cosentyx, Taltz, Siliq, Bimzelx, Dupixent, Adbry, Rinvoq, Cibinqo, Sotyktu, Opzelura. Common mappings: Risankizumab→Skyrizi, Ustekinumab→Stelara, Adalimumab→Humira, Infliximab→Remicade, Guselkumab→Tremfya, Secukinumab→Cosentyx, Ixekizumab→Taltz, Dupilumab→Dupixent. For head-to-head trials, use the drug that showed superior efficacy or the newer/focus drug.
